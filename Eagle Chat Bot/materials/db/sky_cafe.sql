CREATE DATABASE  IF NOT EXISTS `sky_cafe` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `sky_cafe`;
-- MySQL dump 10.13  Distrib 8.0.31, for Win64 (x86_64)
--
-- Host: localhost    Database: sky_cafe
-- ------------------------------------------------------
...
INSERT INTO `food_items` VALUES (1,'Piza',6.00),(2,'Burger',7.00),(3,'Coke',8.00),(4,'Pasta',5.00),(5,'Roast Chicken',6.00),(6,'Biryani',9.00),(7,'Fanta',4.00),(8,'Chips',7.00),(9,'Pepsi',5.00);
...
--
-- Dumping routines for database 'sky_cafe'
--
